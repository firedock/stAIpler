...
function getLayerGuidance(kind: LayerType): string {
  const guidance: Record<LayerType, string> = {
    ...
    style: 'Defines the AI\'s communication style — tone, formatting, and voice. Should specify formality level, emoji usage, response structure, and how to match the user\'s emotional state.',
